    ...
    <div className="shop-page">
      <header className="shop-header">
        ...
        <nav className="shop-nav">
          ...
          <a className={vistaCatalogo === 'nuevos' ? 'activo' : ''} href="#productos" onClick={(e) => { e.preventDefault(); setVistaCatalogo('nuevos'); irSeccion('productos'); }}>Nuevos</a>
          <a className={vistaCatalogo === 'destacados' ? 'activo' : ''} href="#productos" onClick={(e) => { e.preventDefault(); setVistaCatalogo('destacados'); irSeccion('productos'); }}>Destacado</a>
          <a className={vistaCatalogo === 'agotados' ? 'activo' : ''} href="#productos" onClick={(e) => { e.preventDefault(); setVistaCatalogo('agotados'); irSeccion('productos'); }}>Agotado</a>
